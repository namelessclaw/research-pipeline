...
// --- Config ---
const VERTICAL_LABEL = 'Passive Income Opportunities for Indie Makers & Freelancers 2026';
const OUT_DIR = path.resolve(__dirname, 'output');

// Web search queries targeting concrete income ideas
const SEARCHES = [
  'best passive income ideas indie makers freelancers 2026',
  'micro SaaS profitable niches 2026 small teams',
  'information product business monetized automation 2026',
  'AI agent services freelance automation 2026',
  'digital product marketplace income automation 2026',
  'membership site newsletter monetization strategies 2026',
  'self-hosted tools subscription model indie developers',
  'affiliate marketing automation income 2026',
];
...
1. Names the single most compelling micro-SaaS or indie-friendly income opportunity right now (1 sentence — specific, surprising, under-the-radar)
2. Lists exactly 3 concrete income/project ideas, each with:
   - What it is (specific — what you'd actually build or do)
   - Why it works (the actual mechanism — why someone pulls out their wallet)
   - Estimated time to first dollar (realistic for a solo dev working Evenings/weekends)
   - Key risk or bottleneck (real one, not "you need to build an audience")
3. Closes with 1 sentence on the single most important trend for indie devs in 2026

Rules: Plain English. No "leverage", no "synergy", no "AI-powered ecosystems". If a普通人 wouldn't say it, don't write it. Output markdown only.`;
...
async function main() {
  ...
  const outPath = path.join(OUT_DIR, `passive-income-${timestamp}.md`);
